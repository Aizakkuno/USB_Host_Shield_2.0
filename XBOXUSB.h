...
#define XPLORER_VID                             0x1430 // Guitar Hero X-plorer (wired, added in this fork)
...
#define XPLORER_PID                             0x4748 // Guitar Hero X-plorer (wired, added in this fork)
...
public:
        ...
        virtual bool VIDPIDOK(uint16_t vid, uint16_t pid) {
                return ((vid == XBOX_VID || vid == MADCATZ_VID || vid == JOYTECH_VID || vid == GAMESTOP_VID || vid == XPLORER_VID) && (pid == XBOX_WIRED_PID || pid == MADCATZ_WIRED_PID || pid == GAMESTOP_WIRED_PID || pid == AFTERGLOW_WIRED_PID || pid == JOYTECH_WIRED_PID || pid == XPLORER_PID));
        };
        /**@}*/
